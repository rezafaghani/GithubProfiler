...
namespace Profiler.Infrastructure
{
    public class ProfileContext : DbContext, IUnitOfWork
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new GithubProfileEntityTypeConfiguration());
            modelBuilder.ApplyConfiguration(new ProfileRepoEntityTypeConfiguration());
        }
